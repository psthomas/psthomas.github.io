...
I finally got around to parsing the Catalist [demographic margins dataset](https://medium.com/@yghitza_48326/revisiting-what-happened-in-the-2018-election-c532feb51c0#_ftn1) and combined it with the Elections Project [turnout dataset](http://www.electproject.org/home/voter-turnout/demographics). The nice thing about these two sources is that they cover every 2 years, which allows us to look at the house election results between presidential years. 

To get state level results in non-presidential years, I aggregated the [house election results](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/IG0UN2) for each state from the MIT Elections Lab, and then combined these results with the Election Project [state turnout data](http://www.electproject.org/home/voter-turnout/voter-turnout-data). Instead of comparing against a weighted average of the past three elections, the bubble tails are staggered by 4 years so the presidential and house election results are compared against each other.  
...
There's a lot to take in here, but I think the most striking thing is the increase in turnout and leftward shift in 2018. Blue wave indeed. This change largely seems to be driven by college educated voters. Another crucial thing to note here is that in 2018 the aggregate house vote crossed into Democratic territory in both Wisconsin (Rep -7.5%) and Arizona (Rep -1.71%). These will be crucial swing states for the presidency and senate in 2020, so things could get interesting. 
...
[7] Revisiting What Happened in the 2018 Election. Yair Ghitza. [https://medium.com/@yghitza_48326/revisiting-what-happened-in-the-2018-election-c532feb51c0#_ftn1](https://medium.com/@yghitza_48326/revisiting-what-happened-in-the-2018-election-c532feb51c0#_ftn1), [https://docs.google.com/spreadsheets/d/1UwC_GapbE3vF6-n1THVbwcXoU_zFvO8jJQL99ouX3Rw/edit?ts=5beae6d4#gid=433702266](https://docs.google.com/spreadsheets/d/1UwC_GapbE3vF6-n1THVbwcXoU_zFvO8jJQL99ouX3Rw/edit?ts=5beae6d4#gid=433702266)
