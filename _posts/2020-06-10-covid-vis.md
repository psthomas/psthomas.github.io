...
The idea here is that people can use these probabilies to estimate the risk of their lifestyle given their location. So if there's a 1% chance that someone is infected in your region, attending a meeting with 10 individuals means there's a 10% chance of getting exposed to a person with Covid-19 (1-(1-0.01)^10 = 0.095). And your overall risk over the course of the pandemic would be the sum of these probabilities multiplied times your exposure at each time step. 
