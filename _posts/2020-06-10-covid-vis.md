...
New York state also completed a [serology study](https://twitter.com/NYGovCuomo/status/1253352837255438338) on April 23rd that estimated a New York City infection rate of `21.2%` and a statewide rate of `13.9%`. The model predictions of `20.9%` city and `12.5%` state as of 4/23/2020 are quite close. So overall I'm pretty happy with this model and will probably continue using it. 
