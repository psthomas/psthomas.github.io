...
**Update:** I recently found sources of campaign level funding data, so I included a table with the funding gaps below. Note that this is a sum of all the FEC/State reported funding for both primary and general election candidates because I think this is a better measure of "total effort". But as of writing this, the Senate races still seem to be the ones with the largest funding gaps.
